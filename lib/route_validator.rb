class RouteValidator < ActiveModel::EachValidator
  def validate_each(record, attribute, value)
    ...
    valid = begin
      ...
      valid = route[:controller] == 'duckrails/mocks' && route[:action] == 'mockify' && route[:duckrails_mock_id] == record.id
